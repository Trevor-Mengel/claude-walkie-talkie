// One `walkie init` in its own process, released at a shared instant.
//
// argv: <projectDir> <identitiesPath> <namespace> <startAtEpochMs>
// exit 0 = registered, 3 = refused with a walkie error, 1 = anything else.

import { initCommand } from '../../src/cli/init.js';

const [dir, identities, namespace, startAt] = process.argv.slice(2);

process.env.WALKIE_IDENTITIES = identities;
process.chdir(dir);
